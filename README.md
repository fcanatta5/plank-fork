...
- Added CyberNeon, Synthwave, and QuantumGlass futuristic themes
- Added theme-driven glass highlights, accent lines, outer glow, and scanline rendering
- Added theme-driven hover glow pulses, active item breathing pulses, and neon progress styling
- Added theme options to set the indicator, active item, and badge styles

## Themes

Plank Reloaded ships with nine built-in themes. You can switch themes in **Preferences → Appearance → Theme**.
...
A heavy cyberpunk glass theme with cyan/magenta glow, animated hover halos, scanlines, active-item breathing, and neon progress bars.

### Synthwave

A retro-futuristic purple/orange theme with warm neon accents, pulsing item hover glow, and vivid solid badges.

### QuantumGlass

A cleaner translucent sci-fi glass theme with ice-blue accents, subtle scanlines, and softer active/hover pulses.
